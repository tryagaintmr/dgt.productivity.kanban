...
var RestProxy = (function () {
    ...
    RestProxy.prototype.serve = function (callback) {
        var _this = this;
        (function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ctx = _a.sent();
                        context = __assign({}, ctx, { proxyHostUrl: this.settings.protocol + "://" + this.settings.hostname + ":" + this.settings.port });
        ...
        }); })().catch(function (err) { return _this.logger.error('Error', err); });
    };
    return RestProxy;
}());
