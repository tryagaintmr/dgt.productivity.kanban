    ...
    function RestPostRouter(context, settings) {
        ...
        _this.processPostRequest = function (body, req, res) {
            ...
            _this.spr.requestDigest(endpointUrl.split('/_api')[0])
                ...
                headers = __assign({}, headers, { 'X-RequestDigest': headers['X-RequestDigest'] || digest });
                ...
                return _this.spr.post(endpointUrl, __assign({ headers: headers, body: body }, jsonOption, { agent: agent }));
            })
